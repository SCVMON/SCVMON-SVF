...
public:
    ...
    static const llvm::cl::opt<std::string> SrcFile;
    static const llvm::cl::opt<std::string> SnkFile;
    static const llvm::cl::opt<std::string> IncFile;
    static const llvm::cl::opt<std::string> AddEdgeFile;

    static const llvm::cl::opt<std::string> DebugOnly;
